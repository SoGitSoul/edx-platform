    ...
    def post(self, request):
        ...
        try:
            ...
            if explicit_linked_enterprise and has_api_key_permissions and enterprise_enabled():
                ...
                try:
                    enterprise_api_client.post_enterprise_course_enrollment(username, six.text_type(course_id), None)
            ...
            enrollment = api.get_enrollment(username, six.text_type(course_id))
            ...
            if has_api_key_permissions:
                current_enrollment = api.get_enrollment(username, six.text_type(course_id))
                audit_log(
